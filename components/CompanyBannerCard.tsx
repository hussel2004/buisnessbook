...
const navigationLinks = [
  { name: 'Home', icon: Home, href: '/company/[id]' },
  { name: 'About', icon: Users, href: '/company/[id]/about' },
  { name: 'Promotions', icon: Megaphone, href: '/company/[id]/promotions' },
  { name: 'Posts', icon: Newspaper, href: '/company/[id]/posts' },
];
